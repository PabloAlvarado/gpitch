...
def evaluation_notebook(gpu='0', inst=0, nivps=[20, 20], maxiter=[1, 1], learning_rate=[0.0025, 0.0025], minibatch_size=None,
                        frames=16000, start=0, opt_za=False, window_size=8001, disp=False, overlap=True):
    """
