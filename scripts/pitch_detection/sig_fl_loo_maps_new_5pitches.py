'''Detection of two pitches using sigmoid model'''
import numpy as np
import scipy as sp
...
import sys
sys.path.append("../GPmir")
sys.path.append("../lik/sigGP")
import GPmir as gpm
import siggp
reload(siggp)
reload(gpm)
...
os.environ["CUDA_VISIBLE_DEVICES"]="1" # configuration use only one GPU
