...
amtgp.init_settings(visible_device = '0', interactive=True) #  configure gpu usage and plotting
N = 32000 # numer of data points to load
fs, y = amtgp.wavread('../data/60_1-down.wav', start=5000, N=N) # load two seconds of data
...
m = modpdet.ModPDet(x=x, y=y, fs=fs, ws=ws, jump=dsamp)
